    ...
    return (
        <div className="min-h-screen min-h-[100dvh] flex flex-col justify-between py-4 sm:py-8 px-3.5 sm:px-6 lg:px-8 relative w-full max-w-full overflow-x-hidden"
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-20 -right-20 w-64 sm:w-80 h-64 sm:h-80 rounded-full opacity-20"
                    style={{ background: 'radial-gradient(circle, var(--color-primary) 0%, transparent 70%)' }} />
                <div className="absolute -bottom-20 -left-20 w-72 sm:w-96 h-72 sm:h-96 rounded-full opacity-15"
